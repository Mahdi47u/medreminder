...
public class MedicineAdd extends AppCompatActivity{
    ...
    private void btnAddMed(final String user_id, final String m_name, final String m_dosage, final String m_frequency, final String m_indication, final String m_sdate, final String m_edate) {
        ...
        LocalStore.addMedicine(MedicineAdd.this, user_id, m_name, m_dosage, m_frequency,
                m_indication, m_sdate, m_edate);
        SharedPreferences.Editor editor = shared.edit();
        editor.putString("last_scientific_name",m_name);
        editor.putString("last_dosage",m_dosage);
        editor.putString("last_schedule",m_frequency);
        editor.putString("last_indication",m_indication);
        editor.putString("last_s_date",m_sdate);
        editor.putString("last_e_date",m_edate);
        editor.apply();
        Toast.makeText(MedicineAdd.this, "Medicine added", Toast.LENGTH_SHORT).show();
        show();
