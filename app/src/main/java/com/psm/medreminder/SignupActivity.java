...
public class SignupActivity extends Activity {
    ...
    String url = ApiConfig.endpoint("signup.php");
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                } else if (!p_pswd.equals(p_cpswd)) {
                    Toast.makeText(SignupActivity.this, "Passwords do not match", Toast.LENGTH_SHORT).show();
                } else if (LocalStore.userExists(SignupActivity.this, p_email)) {
                    Toast.makeText(SignupActivity.this, "Email already registered", Toast.LENGTH_SHORT).show();
                }else {

                    LocalStore.saveUserAndLogin(SignupActivity.this, p_name, p_gender, p_bdate, p_email,
                            p_pswd, p_weight, p_height, p_bp, p_disease);
                    show();
